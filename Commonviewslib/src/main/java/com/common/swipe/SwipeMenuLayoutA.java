 ...
 * Date: 16/04/24
 */
public class SwipeMenuLayoutA extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static SwipeMenuLayoutA mViewCache;
    ...
    public SwipeMenuLayoutA(Context context) {
        this(context, null);
    }

    public SwipeMenuLayoutA(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuLayoutA(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public SwipeMenuLayoutA setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public SwipeMenuLayoutA setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static SwipeMenuLayoutA getViewCache() {
        return mViewCache;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = SwipeMenuLayoutA.this;
